...
public class POServlet extends HttpServlet {
	...
	@Override
	/**
	 * Allows Put operations from web service to be processed for Purchase Orders
	 * Only allows the amount of a purchase order to be changed
	 * This would be used to increase the funds of a PO, or set the funds to 0
